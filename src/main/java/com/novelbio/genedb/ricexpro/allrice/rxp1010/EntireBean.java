package com.novelbio.genedb.ricexpro.allrice.rxp1010;
...
@Gecco(matchUrl = "http://ricexpro.dna.affrc.go.jp/RXP_1010/view-plot-data.php?featurenum={FeatureNum}", timeout = 2400000, pipelines = "rxp1010SignalPipelines")
