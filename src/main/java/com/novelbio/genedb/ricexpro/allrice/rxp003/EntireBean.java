...
@Gecco(matchUrl = "http://ricexpro.dna.affrc.go.jp/RXP_0003/view-plot-data.php?featurenum={FeatureNum}", timeout = 2400000, pipelines = "rxp003SignalPipelines")
