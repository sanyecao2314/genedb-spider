package com.novelbio.genedb.ricexpro.allrice.rxp007;
...
@PipelineName("rxp007SignalPipelines")
public class Rxp007SignalPipelines implements Pipeline<EntireBean> {
		...
		try {
			...
			for (RawBean rawBean : rawBeans) {
				...
				rawContext.append(rawBean.getRep()).append("\t").append("13-DAT:").append(rawBean.getDat13())
						...
						.append("\t").append("104-DAT:").append(rawBean.getDat104());
			...
			for (NormalizedBean nrmBean : normalizedBeans) {
				...
				nrmContext.append(nrmBean.getRep()).append("\t").append("13-DAT:").append(nrmBean.getDat13())
						...
						.append("\t").append("104-DAT:").append(nrmBean.getDat104());
