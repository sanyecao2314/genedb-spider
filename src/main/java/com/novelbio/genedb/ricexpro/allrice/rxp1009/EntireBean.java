package com.novelbio.genedb.ricexpro.allrice.rxp1009;
...
@Gecco(matchUrl = "http://ricexpro.dna.affrc.go.jp/RXP_1009/view-plot-data.php?featurenum={FeatureNum}", timeout = 2400000, pipelines = "rxp1009SignalPipelines")
