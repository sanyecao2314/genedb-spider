package com.novelbio.genedb.ricexpro.allrice.rxp1001;
...
@Gecco(matchUrl = "http://ricexpro.dna.affrc.go.jp/RXP_1001/view-plot-data.php?featurenum={FeatureNum}", timeout = 2400000, pipelines = "rxp1001SignalPipelines")
