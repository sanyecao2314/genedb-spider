...
public class RawBean implements HtmlBean {
	...
	public String getDat112() {
		return dat112;
	}

	public void setDat112(String dat112) {
		this.dat112 = dat112;
	}

	public String getDat119() {
		return dat119;
	}

	public void setDat119(String dat119) {
		this.dat119 = dat119;
	}

	public String getDat126() {
		return dat126;
	}

	public void setDat126(String dat126) {
		this.dat126 = dat126;
	}
