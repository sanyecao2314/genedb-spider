package com.novelbio.genedb.ricexpro.allrice.rxp1002;
...
@Gecco(matchUrl = "http://ricexpro.dna.affrc.go.jp/RXP_1002/view-plot-data.php?featurenum={FeatureNum}", timeout = 2400000, pipelines = "rxp1002SignalPipelines")
