...
@Gecco(matchUrl = "http://ricexpro.dna.affrc.go.jp/GGEP/view-plot-data.php?featurenum={FeatureNum}", timeout = 2400000, pipelines = "geepSignalPipelines")
