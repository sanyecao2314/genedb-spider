...
@Gecco(matchUrl = "http://ricexpro.dna.affrc.go.jp/RXP_0005/view-plot-data.php?featurenum={FeatureNum}", timeout = 2400000, pipelines = "rxp005SignalPipelines")
