package com.novelbio.genedb.ricexpro.allrice.rxp1008;
...
@Gecco(matchUrl = "http://ricexpro.dna.affrc.go.jp/RXP_1008/view-plot-data.php?featurenum={FeatureNum}", timeout = 2400000, pipelines = "rxp1008SignalPipelines")
