...
@Gecco(matchUrl = "http://ricexpro.dna.affrc.go.jp/RXP_0011/view-plot-data.php?featurenum={FeatureNum}", timeout = 2400000, pipelines = "rXP011_SignalPipelines")
