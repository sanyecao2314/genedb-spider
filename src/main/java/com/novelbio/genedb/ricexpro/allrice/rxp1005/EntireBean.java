package com.novelbio.genedb.ricexpro.allrice.rxp1005;
...
@Gecco(matchUrl = "http://ricexpro.dna.affrc.go.jp/RXP_1005/view-plot-data.php?featurenum={FeatureNum}", timeout = 2400000, pipelines = "rxp1005SignalPipelines")
