...
@Gecco(matchUrl = "http://ricexpro.dna.affrc.go.jp/RXP_1004/view-plot-data.php?featurenum={FeatureNum}", timeout = 2400000, pipelines = "rxp1004SignalPipelines")
