...
public class RXPResultPipelines implements Pipeline<RXPBeanList> {
	...
	public void process(RXPBeanList RXPBeanList) {
		...
		String title = "NO	DATA SET ID	ELAPSED TIME	EXPERIMENT NAME	Cy3_SAMPLE NAME	Cy5_SAMPLE NAME	GRC#	Structure Development Stage	Anatomical Entity";
		...
		for (RXPBean RXPBean : RXPBeanList.getRxpBeans()) {
			String result = RXPBean.getNo() + "\t" + RXPBean.getData_set_id() + "\t" + RXPBean.getElapsed_time() +
