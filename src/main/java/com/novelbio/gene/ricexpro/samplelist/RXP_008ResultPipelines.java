...
@PipelineName("RXP_008ResultPipelines")
public class RXP_008ResultPipelines implements Pipeline<RXP_008BeanList>{
	
	@Override
	public void process(RXP_008BeanList rxp_008BeanList) {
		...
		WriteUtil.writeTxt(title, "/home/novelbio/桌面/RXP_008.csv");
		for (RXP_008Bean RXPBean : rxp_008BeanList.getRxp_008Beans()) {
			...
			WriteUtil.writeTxt(result, "/home/novelbio/桌面/RXP_008.csv");
		}
	}
